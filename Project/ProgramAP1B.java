...
/* Kelompok 4
    Hilal Rizaki        (50421605)
    Ikhwan Fadhilah     (51421603)
    Irsyad Abdurrahman  (50421667)
    Kevin Haris Winarno (50421725)
    Marcel Adila Jufai  (50421773)
    */

public class ProgramAP1B {
    public static void main(String[] args) {
        ProgramAP1B menuuu = new ProgramAP1B();
    ...
    void infosaldo(){
        int saldo = 1000000;
        JOptionPane.showMessageDialog(null, "Sisa saldo rekening anda senilai Rp. " + saldo);
    }
    void transfersaldo(){
